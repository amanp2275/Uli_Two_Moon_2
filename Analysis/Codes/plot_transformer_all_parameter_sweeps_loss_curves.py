"""Plot all Transformer parameter-sweep loss curves in dedicated sweep columns."""
...
SWEEPS = (
    ("Learning rate", ("EXP_005", "EXP_006", "EXP_007", "EXP_008"), "learning_rate", ""),
    ("Weight decay", ("EXP_013", "EXP_014", "EXP_015", "EXP_016"), "weight_decay", ""),
    ("Block count", ("EXP_025", "EXP_026"), "num_blocks", " blocks"),
    ("Head dimension", ("EXP_029", "EXP_030"), "head_dim", ""),
    ("Expansion", ("EXP_032", "EXP_033", "EXP_034"), "expansion", "x"),
)
...
def main() -> None:
    figure, axes = plt.subplots(4, 5, figsize=(27, 20), sharex=False)
    for column, (title, experiment_ids, parameter, suffix) in enumerate(SWEEPS):
    ...
    figure.suptitle(
        "Transformer parameter sweep: all loss curves",
        fontsize=18,
        fontweight="bold",
        y=0.995,
    )
    ...
    output_path = OUTPUT / "transformer_all_parameter_sweeps_loss_curves.png"
