...
def main() -> None:
    ...
    base = BaseTrainingConfig(output_dir=root / "results" / "same_params", epochs=300, learning_rate=5e-4)
    ...
    save_comparison({"comparison": "same_params", "real_nvp": real_result, "transformer": transformer_result}, root / "results" / "same_params" / "comparison.json")
